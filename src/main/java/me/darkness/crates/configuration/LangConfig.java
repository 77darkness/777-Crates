...
public class LangConfig extends OkaeriConfig {
    ...
    public MessageEntry onlyPlayer = MessageEntry.chat("&#FF0000☹ &cTa komenda może być użyta tylko przez gracza.");
    ...
    public MessageEntry chanceEditPrompt = MessageEntry.chat("&fWpisz wagę szansy dropu &8(np. 50). Szanse automatycznie sumują się do &#00FF00100%&f. Aby anulować, wpisz &#FF0000anuluj&f.");
    public MessageEntry chanceEditCancelled = MessageEntry.chat("&#FF0000☹ &cAnulowano zmianę szansy.");
    public MessageEntry commandEditCancelled = MessageEntry.chat("&#FF0000☹ &cAnulowano zmianę komendy.");
    public MessageEntry chanceEditInvalidNumber = MessageEntry.chat("&#FF0000☹ &cPodaj poprawną liczbę (np. &e25.5 &club &e15&c).");
    public MessageEntry chanceEditOutOfRange = MessageEntry.chat("&#FF0000☹ &cWaga szansy musi być większa od &#FF00000&c.");
    ...
    public MessageEntry crateSaved = MessageEntry.chat("&#00FF00☺ &fZapisano drop ze skrzynki &#00FF00{crate}&f.");
    ...
    public static class MessageEntry extends OkaeriConfig {
        ...
        public void send(CommandSender sender, Map<String, String> placeholders) {
            ...
            if ("TITLE_SUBTITLE".equalsIgnoreCase(type)) {
                if (sender instanceof Player player && message instanceof List<?> list) {
