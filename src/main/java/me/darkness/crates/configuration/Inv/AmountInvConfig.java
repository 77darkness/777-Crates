...
public class AmountInvConfig extends OkaeriConfig {

    public String title = "&0ᴡʏʙɪᴇʀᴢ ɪʟᴏść ꜱᴋʀᴢʏɴᴇᴋ";
    public int rows = 3;
    ...
    private Map<String, GuiItem> createDefaultItems() {
        ...
        m.put("open_1", new GuiItem(
            Material.TRIPWIRE_HOOK,
            10,
            1,
            "&#00FF00&lᴏᴛᴡóʀᴢ 1 ꜱᴋʀᴢʏɴᴋᴇ",
