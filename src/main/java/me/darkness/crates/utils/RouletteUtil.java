...
public final class RouletteUtil {
    ...
    public static List<CrateReward> buildLane(List<CrateReward> pool, int minSize) {
    ...
    public static void placeWinner(List<CrateReward> lane, CrateReward winner, int centerSlot, int finalIndex) {
