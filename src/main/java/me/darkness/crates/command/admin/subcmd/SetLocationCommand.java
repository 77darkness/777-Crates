...
public final class SetLocationCommand extends SubCommand {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        lang().crateLocationSet.send(player, Map.of("crate", crateName));
        return true;
    }
    ...
    @Override public String getName() { return "setlocation"; }
    @Override public String getUsage() { return "/admincrate setlocation <nazwa>"; }
