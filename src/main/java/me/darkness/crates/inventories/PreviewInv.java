...
import me.darkness.crates.configuration.inventories.PreviewInvConfig;
...
public final class PreviewInv {
    ...
    public void open(Player player, Crate crate) {
        PreviewInvConfig cfg = this.plugin.getConfigService().previewInv();
    ...
    private ItemStack formatRewardItem(CrateReward reward, Crate crate, PreviewInvConfig cfg) {
        ...
        if (cfg.rewardPreviewLore.isEmpty()) return display;
